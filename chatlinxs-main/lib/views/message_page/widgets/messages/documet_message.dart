...
class DocumentMessage extends StatefulWidget {
  ...
  const DocumentMessage(
      {super.key, required this.file, required this.isIncomingMessage});
                          ...
                          children: [
                            ...
                            Text(
                              file.fileName.length > 20
                                  ? "${file.fileName.substring(0, 8)}...${file.fileName.substring(
                  ...
                  child: Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          "${(file.bytesSize / 1024 / 1000).toStringAsFixed(2)} MB",
                          style: TextStyle(
                              color:
                                  fromFriend ? Colors.white70 : Colors.black87,
                              fontSize: 12),
